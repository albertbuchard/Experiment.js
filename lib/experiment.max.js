(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("_"), require("EBJS"), require("Promise"), require("experimentBoxes"), require("jQuery"), require("math"));
	else if(typeof define === 'function' && define.amd)
		define("experiment", ["_", "EBJS", "Promise", "experimentBoxes", "jQuery", "math"], factory);
	else if(typeof exports === 'object')
		exports["experiment"] = factory(require("_"), require("EBJS"), require("Promise"), require("experimentBoxes"), require("jQuery"), require("math"));
	else
		root["experiment"] = factory(root["_"], root["EBJS"], root["Promise"], root["experimentBoxes"], root["jQuery"], root["math"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_13__) {
    ...
    value: function addDefaultPauseDesign() {
      ...
      var awakePause = function awakePause() {
        ...
        if (pauseBackground2D !== null) {
          ...
          pauseBackground2D = new _experimentBabylonJs2.default.Rectangle2D({
            parent: canvas,
            id: options.id,
            x: options.x,
            y: options.y,
  ...
  */
  ...
  _createClass(TaskObject, [{
    ...
    value: function create2DScene() {
      ...
      var canvas = new _experimentBabylonJs2.default.ScreenSpaceCanvas2D(scene, {
        id: 'ScreenCanvas',
    ...
    value: function default2dSceneGenerator(options) {
      ...
      var optionsBase = {
        canvasBackground: new _experimentBabylonJs2.default.Color4(1, 0, 1, 1),
      ...
      scene.loadingPromise = _bluebird2.default.resolve();
      ...
      var text = new _experimentBabylonJs2.default.Text2D('Welcome !', {
        id: 'text',
